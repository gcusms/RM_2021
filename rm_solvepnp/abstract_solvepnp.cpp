...
void Abstract_Solvepnp::draw_Coordinate(cv::Mat &_draw_img, cv::Mat &_rvec,
  ...
  cv::line(_draw_img, reference_Img[0], reference_Img[1], cv::Scalar(0, 0, 255),
           2);
  cv::line(_draw_img, reference_Img[0], reference_Img[2], cv::Scalar(0, 255, 0),
           2);
  cv::line(_draw_img, reference_Img[0], reference_Img[3], cv::Scalar(255, 0, 0),
           2);
...
// RM_Solvepnp_Abstract::~RM_Solvepnp_Abstract() {}